...
<CodeGroup show-lines="true" tabs={["curl", "Request using the header", "Sample request with group ID filter"]}>
...
<CodeGroup show-lines="true" tabs={["Available badges", "Earned badges", "Earned badges- Fixed window", "Filter by Group ID"]}>
