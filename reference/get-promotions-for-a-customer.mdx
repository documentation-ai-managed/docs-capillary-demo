...
<CodeGroup show-lines="true" tabs={["cURL","filter by \"entityId\"","with supplementary promotions and increased limit"]}>
  ...
  ```bash wrap="true" "filter by "entityId""
  ...
  ```bash wrap="true" "with supplementary promotions and increased limit"
...
| ....cycleReferenceDate | Long    | Epoch timestamp in milliseconds. The anchor date from which N\_DAY cycles are calculated. Interpreted in the org's configured timezone.                                                                                                                                                                                                                                                                          |
