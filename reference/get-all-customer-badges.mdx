...
<CodeGroup show-lines="true" tabs={["when badgeType=EARNED","When badgeType=EARNED and badgeStatus=LIVE","When Owner=Loyalty and badgeType=EARNED","When badgeStatus=UPCOMING and badgeType=AVAILABLE","When badgeType=EXPIRED","Filter by group ID"]}>
  ```json
  {
      "data": {
          "customerBadges": [
