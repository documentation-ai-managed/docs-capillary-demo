...
| URI                    | /api\_gateway/rewards/core/v1/vendor/brand/1 |
| :--------------------- | :------------------------------------------- |
| HTTP Method            | GET                                          |
| Pagination             | Yes                                          |
| Batch support          | No                                           |
...
<CodeGroup show-lines="true" tabs={["When enabled=false","When enabled=true","Failure: Invalid Brand ID","With sortBy=lastUpdatedOn","Generic","With Vendor code Filter"]}>
  ```json wrap="true" "When enabled=false"
  {
      "status": {
          "success": true,
          "code": 5001,
  ...
  ```json wrap="true" "When enabled=true"
  {
      "status": {
          "success": true,
          "code": 5001,
  ...
  ```json wrap="true" "Failure: Invalid Brand ID"
  {
      "status": {
          "success": false,
          "code": 3004,
