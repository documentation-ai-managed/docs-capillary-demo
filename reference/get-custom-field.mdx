...
<CodeGroup show-lines="true" tabs={["Sample request with sortBy=lastUpdatedOn&orderBy=DESC&scope=CATALOGUE_PROMOTION","Sample request with sortBy-lastUpdatedOn","Sample request With scope=REWARD","Sample request With scope=ISSUE_REWARD","Sample request With scope=CATALOGUE_PROMOTION"]}>
  ```bash wrap="true" "Sample request with sortBy=lastUpdatedOn&orderBy=DESC&scope=CATALOGUE_PROMOTION"
  ...
  ```bash wrap="true" "Sample request with sortBy-lastUpdatedOn"
  ...
  ```bash wrap="true" "Sample request With scope=REWARD"
  ...
  ```bash wrap="true" "Sample request With scope=ISSUE_REWARD"
  ...
  ```bash wrap="true" "Sample request With scope=CATALOGUE_PROMOTION"
...
<CodeGroup show-lines="true" tabs={["Sample response With sortBy=lastUpdatedOn&orderBy=DESC&scope=CATALOGUE_PROMOTION","Sample response With scope=ISSUE_REWARD","Sample response With scope=REWARD","Sample response With scope= CATALOG_PROMOTION","Sample response With sortBy=lastUpdatedOn"]}>
