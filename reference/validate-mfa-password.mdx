...
<Image src="https://files.readme.io/f1f2d3a-password_validate.jpg" width="439" height="610" alt="Flow Chart below illustrates the steps" />
...
<CodeGroup default-tab="0" show-lines="true" tabs={["Sample request"]}>
  ```text "Sample request"
...
<CodeGroup default-tab="0" show-lines="true" tabs={["Sample response"]}>
