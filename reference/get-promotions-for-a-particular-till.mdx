...
- To retrieve promotions for a customer-specific context, use the [Get Cart Promotions for a Customer API](/reference/get-promotions-for-a-customer) instead.
...
| ....windowType                  | Enum    | Defines the type of limit window applied to the restriction. Possible values: `OVERALL`, `MOVING`, `FIXED`, `CLASSIC`.                                                                                                                                                                                                                                                               |
...
| .....cycleReferenceDate         | Long    | Epoch timestamp in milliseconds. The anchor date from which N\_DAY cycles are calculated. Interpreted in the org's configured timezone. Defaults to the promotion's `startDate` if omitted.                                                                                                                                                                                          |
