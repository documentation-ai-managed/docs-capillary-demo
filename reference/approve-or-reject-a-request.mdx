...
<CodeGroup show-lines="true" tabs={["Customer identifier change","Points redemption","Issue goodwilll","Earn badge","Issue badge (Enrol customers to badge)","Retro transaction"]}>
  ```json wrap="true" "Customer identifier change"
  {
      "data": {
  ...
  ```json wrap="true" "Points redemption"
  {
      "data": {
          "requestId": "d9df3b65-62a7-11ee-aa6d-0aaee4e533d2",
          "userId": 232134,
  ...
  ```json wrap="true" "Issue goodwilll"
  {
      "data": {
  ...
  ```json wrap="true" "Issue badge (Enrol customers to badge)"
  {
      "data": {
  ...
  ```json wrap="true" "Retro transaction"
  {
      "data": {
