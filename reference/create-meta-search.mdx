...
<CodeGroup show-lines="true" tabs={["Create Transaction Search Criteria","Create Customer Search Criteria"]}>
  ```bash "Create Transaction Search Criteria"
...
| ..fieldReference     | String  | Yes         | Applicable in **`COMBINATION`** criteria when you include custom, extended, or additional fields. **Examples** `extendedFields.ship_email` - lets you search customers by their shipping email. `customFields.age` → lets you search customers by a custom age field. `additionalFields.storecode` → _(transaction only)_, lets you search transactions by store code.                                                                                                                                                                                                                                                            |
