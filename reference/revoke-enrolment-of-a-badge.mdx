...
<CodeGroup show-lines="true" tabs={["With Revoke Issuals", "With only customers"]}>
...
<CodeGroup show-lines="true" tabs={["Single customer", "Multiple customers", "With Revoke Issuals", "Failure: Customer is not issued", "Failure: Issued badge doesn't belong to customer", "Failure: RevokeIssuals or CustomerId is mandatory"]}>
