...
| ---------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| brandId\*                                            | Long      | Unique identifier for the brand. To retrieve brandId, refer to the [Retrieve Brand ID API](/reference/retrieve-brand-id). |
...
<CodeGroup show-lines="true" tabs={["Sample Response", "Invalid brandId", "Category name null"]}>
