...
<CodeGroup show-lines="true" tabs={["Response: With OTHER as DATA-SCOPE","Response: With SELF as DATA-SCOPE","Failure: With ALL as a scope","With 'altText' for images and videos"]}>
  ```json wrap="true" "Response: With OTHER as DATA-SCOPE"
  {
      "status": {
          "success": true,
          "code": 6001,
  ...
  ```json wrap="true" "Response: With SELF as DATA-SCOPE"
  {
      "status": {
          "success": true,
          "code": 6001,
  ...
  ```json wrap="true" "Failure: With ALL as a scope"
  {
      "data": null,
      "errors": [
          {
