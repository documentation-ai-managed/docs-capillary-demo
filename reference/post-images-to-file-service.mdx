...
| Parameter                | Data Type | Description                                                                                                                                                                                                                                                                     |
| :----------------------- | :-------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **`File path location`** | String    | The location of the image stored on your computer. If a file path is provided, the image is stored in S3. **Example**: `@/Users/nikhil/Downloads/IMG_20220730_180352311.jpg`**Note**: If no file path is given, a placeholder is created in the S3 location to store the image. |
