...
<CodeGroup default-tab="3" show-lines="true" tabs={["With userId","With category=accessories","With groupName=Most Preferred Rewards","With sortOnGroups=true","With 'altText' for images and videos"]}>
  ```json wrap="true" "With userId"
  {
      "status": {
          "success": true,
          "code": 200,
  ...
  ```json wrap="true" "With category=accessories"
  {
      "status": {
          "success": true,
          "code": 200,
  ...
  ```json wrap="true" "With groupName=Most Preferred Rewards"
  {
      "status": {
          "success": true,
          "code": 200,
  ...
  ```json wrap="true" "With sortOnGroups=true"
  {
      "status": {
          "success": true,
          "code": 200,
