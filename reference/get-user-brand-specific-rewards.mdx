...
<CodeGroup show-lines="true" tabs={["With userId","With category=accessories","With groupName=Most Preferred Rewards","With sortOnGroups=true","With 'altText' for images and videos"]}>
