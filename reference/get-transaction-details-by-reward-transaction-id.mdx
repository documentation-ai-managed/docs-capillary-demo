...
<CodeGroup show-lines="true" tabs={["With couponCodeCase filter"]}>
  ```bash wrap="true"
  ...
  ```text wrap="true" "With couponCodeCase filter"
...
| ``                            | object    | Contains the status of the reward issuance.                                                                                                                                                                                                                                                                                             |
...
| ``                            | object    | Contains details of the issued reward.                                                                                                                                                                                                                                                                                                  |
...
| ``                            | object    | Contains details of the points redemption process.                                                                                                                                                                                                                                                                                      |
| `redeemedPoints`              | int       | Number of points redeemed.                                                                                                                                                                                                                                                                                                              |
| `redeemedPointsInDecimal`     | decimal   | Number of points redeemed, expressed as a decimal value rounded to 3 decimal places. Rounding follows the HALF\_UP method, where if the fourth decimal digit is 5 or more, the third decimal rounds up. For example, 21.4555 becomes 21.456, and 21.4554 becomes 21.455. This field will have values only for conversion ratio rewards. |
...
| ``                            | object    | Status details of the points redemption.                                                                                                                                                                                                                                                                                                |
...
| ``                            | object    | Contains details of the redemption process.                                                                                                                                                                                                                                                                                             |
...
| ``                            | array     | A list of vouchers associated with the redemption.                                                                                                                                                                                                                                                                                      |
...
| ``                            | object    | Stores the vendor reward details.                                                                                                                                                                                                                                                                                                       |
| `rewards`                     | object    | Identifier for the vendor reward.                                                                                                                                                                                                                                                                                                       |
| ``                            | object    | Custom fields for additional information.                                                                                                                                                                                                                                                                                               |
| ``                            | object    | Custom fields associated with the transaction.                                                                                                                                                                                                                                                                                          |
...
<CodeGroup show-lines="true" tabs={["Sample response","With couponCodeCase filter"]}>
  ...
  ```json wrap="true" "With couponCodeCase filter"
  {
      "status": [
          {
              "success": true,
...
| Code  | Description                                                                           |
| :---- | :------------------------------------------------------------------------------------ |
| 10007 | Transaction missing or inaccessible: TRANSACTION\_NOT\_FOUND - Transaction not found. |
