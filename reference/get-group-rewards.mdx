...
```json
{
  ...
  "paths": {
    "/api_gateway/rewards/core/v1/group": {
      "get": {
        "summary": "Groups - Get all rewards group",
        "description": "",
        ...
        "parameters": [
          ...
          },
          {
            "name": "page",
            "in": "query",
            "description": "The amount of the records that you want to retrieve",
            "schema": {
              "type": "integer",
              "format": "int32",
              "default": 10
          ...
          },
          {
            "name": "sortBy",
            "in": "query",
            "description": "Sorts the reward based on the group rank.",
            "schema": {
              "type": "string",
              "enum": [
                "RANK"
            ...
            "content": {
              "application/json": {
                "examples": {
                  ...
                  "Sample response with orderBy=DESC&active=true": {
                    "value": {
                      "status": {
                        "success": true,
                        "code": 12013,
                    ...
                    "summary": "Sample response with orderBy=DESC&active=true"
                  }
                },
                "schema": {
                  "oneOf": [
                      ...
                      "properties": {
                        "status": {
                          ...
                          "properties": {
                            ...
                            "message": {
                              "type": "string",
                              "example": "Get all groups fetched successfully"
                            }
                          }
                        },
                        "groupRoList": {
                          ...
                          "items": {
                            ...
                            "properties": {
                              ...
                              "createdOn": {
                                "type": "integer",
                                "example": 1742180328000,
                                "default": 0
                              },
                              "createdOnDateTime": {
                                "type": "string",
                                "example": "2025-03-17T02:58:48Z"
                              },
                              "lastUpdatedBy": {
                                "type": "integer",
                                "example": 75155282,
                    ...
                    {
                      "title": "with sortOn=LAST_UPDATED_ON",
                      "type": "object",
                      "properties": {
                        "status": {
                          "type": "object",
                        ...
                        "groupRoList": {
                          ...
                          "items": {
                            ...
                            "properties": {
                              ...
                              "createdOn": {
                                "type": "integer",
                                "example": 1741887808000,
                                "default": 0
                              },
                              "createdOnDateTime": {
                                "type": "string",
                                "example": "2025-03-13T17:43:28Z"
                              },
                              "lastUpdatedBy": {
                                "type": "integer",
                                "example": 75155282,
                        ...
                        "groupRoList": {
                          ...
                          "items": {
                            ...
                            "properties": {
                              ...
                              "lastUpdatedOn": {
                                "type": "integer",
                                "example": 1743575719000,
                                "default": 0
                              },
                              "lastUpdatedOnDateTime": {
                                "type": "string",
                                "example": "2025-04-02T06:35:19Z"
                              }
                            }
                          }
                        },
        ...
        "x-readme": {
          "code-samples": [
            {
              "language": "curl",
              "code": "curl --location 'https://eu.api.capillarytech.com/api_gateway/rewards/core/v1/group?orderBy=DESC&active=true' \\\n--header 'Authorization: Basic bWFkajU2YQ==' \\\n--header 'Cookie: _cfuvid=_XMq7vU15Ra4rfJ4eowUt3bE5nF5uk07Qq9cb7Xe63c-1747204203136-0.0.1.1-604800000; _cfuvid=En1D6mn09Bs3S7Mthyzz2LmKmJscmFt47ubQgAHwC.M-1764061935605-0.0.1.1-604800000'",
              "name": "Sample request with orderBy=DESC&active=true"
            },
            {
              "language": "curl",
              "code": "curl --location 'https://eu.api.capillarytech.com/api_gateway/rewards/core/v1/group?sortOn=LAST_UPDATED_ON' \\\n--header 'Authorization: Basic Z2VvcmEzNzg=' \\\n--header 'Cookie: _cfuvid=_XMq7vU15Ra4rfJ4eowUt3bE5nF5uk07Qq9cb7Xe63c-1747204203136-0.0.1.1-604800000'",
              "name": "Sample request with sortOn=LAST_UPDATED_ON"
            },
            {
              "language": "curl",
              "code": "curl --location 'https://eu.api.capillarytech.com/api_gateway/rewards/core/v1/group?sortOn=LAST_UPDATED_ON' \\\n--header 'Authorization: Basic bWFkaHMjU2YQ==' \\\n--header 'Cookie: _cfuvid=_XMq7vU15Ra4rfJ4eowUt3bE5nF5uk07Qq9cb7Xe63c-1747204203136-0.0.1.1-604800000; _cfuvid=BNKMdc2rm4I7MYA3KIlxZDn.nhxE7URS3m2d4Ipaduo-1764062400363-0.0.1.1-604800000'",
              "name": "Sample request with orderBy=DESC"
            }
          ],
          "samples-languages": [
            "curl"
