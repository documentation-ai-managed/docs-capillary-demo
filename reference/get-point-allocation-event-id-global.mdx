...
<CodeGroup show-lines="true" tabs={["using transaction ID"]}>
  ```bash wrap="true" "using transaction ID"
...
| --------------- | --------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| entity\_id      | String    | Yes      | Specifies the identifier used to fetch event-specific details. See the list below.&#xA;  • The [event ID ](https://docs.capillarytech.com/reference/get-customer-events-data#/) (eventID in the Get customer Event API response) of the event, such as TransactionAdd or a behavioural event&#xA;  • [The server-generated request ID of a behavioural event](https://docs.capillarytech.com/reference/post-event).&#xA;  • For a `TransactionAdd` event, the Request ID can be retrieved from the **Evaluation Log** in the Member Care UI under **Events** > **Transactions** for the respective transaction.&#xA;  • Transaction ID ([createdId from the Add transaction response](https://docs.capillarytech.com/reference/add-transaction-single#/)) |
| customer\_id    | Long      | Yes      | Unique Customer ID                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| event\_type\_id | Integer   | Yes      | Unique identifier for the type of event. This depends on the kind of event. Refer to the[table below](/reference/get-point-allocation-event-id-global#/example-request)for the event type ID associated with your event.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
