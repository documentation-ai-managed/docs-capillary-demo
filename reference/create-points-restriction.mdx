...
<CodeGroup show-lines="true" tabs={["Sample request","Org level constraint","Org level points constraint","Org level points constraint- Content type","Multiple points constraint","Creation of points constraint that already exists","Points restriction on supplementary program","Points restriction on customer segments","Points Restriction on Customer Loyalty Program","Points Restriction on Customer Label","Points Restriction on Customer Tier"]}>
  ...
  ```json wrap="true" "Org level constraint"
  [
      {   
          "kpi" :"POINTS",
          "constraintLevel" : "CUSTOMER_REDEMPTION_TYPE",
  ...
  ```json wrap="true" "Org level points constraint"
  [
      {
          "orgId": 51544,
          "kpi": "POINTS",
...
<CodeGroup show-lines="true" tabs={["Org level constraint","Org level points constraint","Org level points constraint- Content type","Multiple points constraint","Creation of points constraint that already exists","Points restriction on supplementary program","Points restriction on customer segments","Points Restriction on Customer Loyalty Program","Points Restriction on Customer Label","Points Restriction on Customer Tier"]}>
...
<CodeGroup show-lines="true" tabs={["Sample response","Response-Org level constraints","Response- Multiple content type","Response- Customer points constraint","Response-Content type","Response- Creation of points constraint that already exists","Response - Creation of points restriction on supplementary program","Response- Creation of points restriction on customer segments","Response- Creation of points restriction on customer loyalty program","Response- Creation of points restriction on customer label","Response- Creation of points restriction on customer tier"]}>
  ...
  ```json wrap="true" "Response-Org level constraints"
  [
      {
  ...
  ```json wrap="true" "Response- Customer points constraint"
  [
      {
