...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| 400 BAD\_REQUEST            | • The request body is invalid JSON- Required fields are missing- The request body fails validation - Constraint violations occur |
...
| 500 INTERNAL\_SERVER\_ERROR | • Unexpected server errors occur- Database operations fail- Other runtime exceptions occur                                       |
