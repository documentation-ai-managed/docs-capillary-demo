...
<CodeGroup show-lines="true" tabs={["Org level constraint", "constraintLevel : CUSTOMER", "Multiple Constraints", "constraintLevel : CUSTOMER_SUPPL_PROGRAM", "constraintLevel : CUSTOMER_SEGMENT", "constraintLevel : CUSTOMER_LOYALTY_PROGRAM", "constraintLevel : CUSTOMER_LABEL", "constraintLevel : CUSTOMER_TIER"]}>
...
<CodeGroup show-lines="true" tabs={["Org Level constraint", "constraintLevel: CUSTOMER_REDEMPTION_TYPE", "Multiple constraints", "constraintLevel: CUSTOMER_SUPPL_PROGRAM", "constraintLevel: CUSTOMER_SEGMENT", "constraintLevel: CUSTOMER_LOYALTY_PROGRAM", "constraintLevel: CUSTOMER_LABEL", "constraintLevel : CUSTOMER_TIER"]}>
