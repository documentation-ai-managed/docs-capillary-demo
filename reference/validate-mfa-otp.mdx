...
| :-------------------------------------------------- | :-------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ``\*                                                | Enum      | Customer identifier used for MFA token generation. Values: `MOBILE`, `EMAIL`, `USERNAME`, `EXTERNALID`. If you want to use external ID, [external ID login](https://docs.capillarytech.com/docs/setup_customer#customer-registration-configuration) must be enabled in the organisation settings. |
| ``\*                                                | String    | Value of the identifier.                                                                                                                                                                                                                                                                          |
| ``\*                                                | String    | Unique ID of the device where OTP is validated.                                                                                                                                                                                                                                                   |
| ``\*                                                | String    | Name of the brand or organisation that needs verification.                                                                                                                                                                                                                                        |
| ``\*                                                | String    | Unique session ID created from `/mfa/token/generate` API.                                                                                                                                                                                                                                         |
| ``\*                                                | String    | OTP that needs validation.                                                                                                                                                                                                                                                                        |
