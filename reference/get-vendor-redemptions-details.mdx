...
<CodeGroup show-lines="true" tabs={["Sample request","Sample request With sortOn=lastUpdatedOn, order= DESC, redemptionType= INTOUCH_REWARD"]}>
  ...
  ```bash wrap="true" "Sample request With sortOn=lastUpdatedOn, order= DESC, redemptionType= INTOUCH_REWARD"
...
<CodeGroup show-lines="true" tabs={["Sample response","Failure: Page Number and size are incorrect","Failure: Invalid redemption type","Sample response With sortOn=lastUpdatedOn, order= DESC, redemptionType= INTOUCH_REWARD"]}>
  ...
  ```json wrap="true" "Failure: Page Number and size are incorrect"
  {
      "status": {
          "success": false,
          "code": 8000,
  ...
  ```json wrap="true" "Sample response With sortOn=lastUpdatedOn, order= DESC, redemptionType= INTOUCH_REWARD"
  {
      "status": {
          "success": true,
          "code": 5011,
