...
\<[https://eu.api.capillarytech.com/api\_gateway/rewards/core/v1.1/reward-transactions?customerId=564488660\&redemptionType=INTOUCH\_REWARD%2C%20PHYSICAL\_REWARD](https://eu.api.capillarytech.com/api_gateway/rewards/core/v1.1/reward-transactions?customerId=564488660\&redemptionType=INTOUCH_REWARD%2C%20PHYSICAL_REWARD)>
...
<CodeGroup show-lines="true" tabs={["With rewardId"]}>
  ```bash wrap="true"
...
| `- redemptionType`         | String    | Gives the redemption type of the reward. Example: INTOUCH\_REWARD.                                                                                                                                                                                                                                                                           |
...
<CodeGroup show-lines="true" tabs={["Sample response with redemptionType filter","With rewardId","Generic"]}>
  ```json wrap="true" "Sample response with redemptionType filter"
