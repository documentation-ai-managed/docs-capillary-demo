...
<CodeGroup show-lines="true" tabs={["entityType=CUSTOMER","entityType=CARD","includeUserContext=true","entityType=CUSTOMER&referenceType=StandardField","entityType=CUSTOMER&referenceType=CustomerStatus","entityType=CUSTOMER&pageNo=1&limit=10","entityType=CUSTOMER&startDate=2023-12-05&endDate=2023-12-06","with victim and survivor details"]}>
  ```json wrap="true" entityType=CUSTOMER
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```json wrap="true" entityType=CARD
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```text wrap="true" includeUserContext=true
  {
      "data": [
  ...
  ```json wrap="true" entityType=CUSTOMER&referenceType=StandardField
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```json wrap="true" entityType=CUSTOMER&referenceType=CustomerStatus
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```json wrap="true" entityType=CUSTOMER&pageNo=1&limit=10
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```json wrap="true" entityType=CUSTOMER&startDate=2023-12-05&endDate=2023-12-06
  {
      "data": [
          {
              "updatedByUser": null,
  ...
  ```json wrap="true" "with victim and survivor details"
  {
      "data": [
          {
              "updatedByUser": null,
...
|   • updatedField      | The field that was updated. (e.g., vehicle\_type).                                                                                                                                                           |
