...
<CodeGroup show-lines="true" tabs={["With payment config","With fullfilment status and custom field","With user_group2_primary_user_id","With params in Reward Level","With params in Request Level","With redemptionValue","With event log ID and request ID","Issuing a reward by defining  Quantity and Redemption Value","Issuing a reward with only quantity"]}>
  ```json
  {
      "status": {
          "success": true,
...
| :------- | :------------------------------------- | :--------------------------------------- |
| user1    | p1, p2                                 | Does not contain r1, r3; contains r2, r4 |
| user2    | p1                                     | Contains r1, r3, r4; does not contain r2 |
