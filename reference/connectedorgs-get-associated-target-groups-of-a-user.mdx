...
<CodeGroup show-lines="true" tabs={["Sample request with targetGroupId", "Sample request with targetId"]}>

  ```bash Sample request with targetGroupId
  ...
  ```bash Sample request with targetId
...
<CodeGroup show-lines="true" tabs={["Sample response with targetGroupId", "Sample response with targetId"]}>

  ```bash Sample response with targetGroupId
  {
      "data": {
          "userId": 566135941,
          "customer": {
  ...
  ```bash Sample response with targetId
  {
      "data": {
          "userId": 566135941,
          "customer": {
...
<CodeGroup show-lines="true" tabs={["Get all milestones", "Get all user created milestones", "enrolmentMethod=AUDIENCE_FILTER", "Get leaderboard enabled milestones"]}>
