...
const response = await fetch(
  "https://eu.intouch.capillarytech.com/v2/customers/565261498?source=INSTORE&ndncStatus=true&optinStatus=true&slabHistory=true&tierUpgradeCriteria=true&membershipRetentionCriteria=true",
  {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
<CodeGroup tabs="Sample request,Sample request with ndnc, optinStatus, slabHistory, MembershipRetensionCriteria">
